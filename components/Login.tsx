        ...
        <div className="hidden md:flex md:w-5/12 bg-gradient-to-br from-indigo-900 via-indigo-800 to-blue-900 text-white relative flex-col justify-between p-12 lg:p-16 overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-indigo-100 text-lg leading-relaxed max-w-sm">
              The enterprise-grade operating system for modern HR teams.
              AI-driven recruitment, seamless compliance, and smart payroll.
            </p>
          </div>
            ...
            <div className="mt-8 text-center">
              <p className="text-slate-500 text-sm">
                ...
                <button
                  ...
                  className="ml-1 text-indigo-600 font-bold hover:text-indigo-700"
                >
                  Create free account
                </button>
              </p>
            ...
            <div className="mt-12 pt-8 border-t border-slate-100">
              ...
              <div className="grid grid-cols-2 gap-3">
                <button
                  ...
                  className="flex items-center gap-2 p-2 rounded-lg border border-slate-200 hover:bg-indigo-50 hover:border-indigo-200 transition-all text-left group"
                >
                  <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 group-hover:bg-indigo-100 group-hover:text-indigo-600">
                    <User size={14} />
                  </div>
                  <div>
                    <p className="text-xs font-bold text-slate-700 group-hover:text-indigo-800">
                      Company Admin
                    </p>
                ...
                <button
                  // onClick={() => handleDemoClick("candidate@demo.com")}
                  className="flex items-center gap-2 p-2 rounded-lg border border-slate-200 hover:bg-pink-50 hover:border-pink-200 transition-all text-left group"
                >
                  <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 group-hover:bg-pink-100 group-hover:text-pink-600">
                    <Briefcase size={14} />
                  </div>
                  <div>
                    <p className="text-xs font-bold text-slate-700 group-hover:text-pink-800">
                      Candidate
                    </p>
                ...
                <button
                  // onClick={() => handleDemoClick("manager@demo.com")}
                  className="flex items-center gap-2 p-2 rounded-lg border border-slate-200 hover:bg-emerald-50 hover:border-emerald-200 transition-all text-left group"
                >
                  <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 group-hover:bg-emerald-100 group-hover:text-emerald-600">
                    <User size={14} />
                  </div>
                  <div>
                ...
                <button
                  // onClick={() => handleDemoClick("emp@demo.com")}
                  className="flex items-center gap-2 p-2 rounded-lg border border-slate-200 hover:bg-blue-50 hover:border-blue-200 transition-all text-left group"
                >
                  <div className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-slate-500 group-hover:bg-blue-100 group-hover:text-blue-600">
                    <User size={14} />
                  </div>
                  <div>
                    <p className="text-xs font-bold text-slate-700 group-hover:text-blue-800">
                      Employee
                    </p>
